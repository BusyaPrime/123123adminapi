...
return [
    ...
    */
    ...
    // The package hardcodes the route prefix to "/filemanager" in v2.10.1.
    ...
    */
    ...
    // v2.10.1 reads these keys directly.
    ...
    */
    ...
    // Package v2.10.1 resolves category settings through folder_categories.*.
    'folder_categories' => [
        'file' => [
            'folder_name' => 'uploads/files',
            'startup_view' => 'list',
            'max_size' => 50000,
            'thumb' => true,
            'thumb_width' => 200,
