        ...
        @slot('filters')
            <section class="content" id="filter_block" style="{{ $filters['driver_id'] != '' || $filters['user_id'] != '' || $filters['company_id'] != '' || $filters['date_start'] != '' || $filters['date_end'] != '' || $filters['name'] != '' || $filters['region_from_id'] != '' || $filters['region_to_id'] != '' || $filters['cargo_type_id'] != '' || $filters['status'] != '' ?'':'display: none' }}">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <form method="get" action="{{ route('admin2.bookings-available.index') }}" id="filter_block_form">
...
{{--                                            </div>--}}
                                        ...
                                        <div class="row align-items-center justify-content-end">
                                            <div class="col-sm-6 d-flex align-items-center justify-content-end">
                                                <a href="{{ route('admin2.bookings-available.index') }}" class="btn btn-danger mr-2" style="{{ $filters['driver_id'] != '' || $filters['user_id'] != '' || $filters['company_id'] != '' || $filters['date_start'] != '' || $filters['date_end'] != '' || $filters['name'] != '' || $filters['region_from_id'] != '' || $filters['region_to_id'] != '' || $filters['cargo_type_id'] != '' || $filters['status'] != '' ?'':'display: none' }};">Сбросить фильтры</a>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    @foreach($bookings as $booking)
                        <tr class="table__tr mt-2 mb-2 redirect-show-page"  data-url="{{ route('admin2.bookings-available.show', $booking) }}">
                            ...
                            <td class="table__td">
                                {{ $booking->created_at ? $booking->created_at->format('d.m.Y'): 'Нет'}}
                            </td>
