<!-- <div class="form-group row {!! $errors->first('company_id', 'has-danger')!!}">
    <label class="col-md-3 text-md-right col-form-label-sm" for="company_id">Company Id</label>
    <div class="col-md-4">
        {!! $errors->first('company_id', '<small class="form-control-feedback">:message</small>') !!}
    </div>
</div> -->
<input type="hidden" name="company_id" class="form-control input-sm" id="company_id" value="{{ $user_id }}" required autofocus readonly>
...
<div class="form-group row {!! $errors->first('username', 'has-danger')!!}">
    <label class="col-md-3 text-md-right col-form-label-sm" for="username">@lang('validation.attributes.phone_number') </label>
    <div class="col-md-4">
    ...
    <div class="col-md-5">Номер телефона - 998XX0000000</div>
</div>
...
{{--        {!! $errors->first('balance', '<small class="form-control-feedback">:message</small>') !!}--}}
{{--    </div>--}}
{{--</div>--}}
