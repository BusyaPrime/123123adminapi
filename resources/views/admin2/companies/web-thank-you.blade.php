...
<link href="/vendor/font-iconmoon/style.css" rel="stylesheet">
<!-- Bootstrap 4 -->
...
setTimeout(function() {
    ...
    <script type="text/javascript"
            src="/vendor/inputmask/jquery.inputmask.bundle.js"></script>
    <script>
        $(function () {
...
<script type="text/javascript"
            src="/vendor/bootstrap-show-password/bootstrap-show-password.min.js"></script>
    <script>
        $(function () {
            $('.password').password({
                eyeClass: '',
...
<script>
    setTimeout(function(){
            window.location.href = "{{ 'https://'.request()->getHttpHost() }}";
         }, 5000);
</script>
</body>
</html>
