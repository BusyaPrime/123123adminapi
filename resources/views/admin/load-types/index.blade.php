...
@section('center_content')
    @component('component.card', ['title' => trans('admin.nav.load-types'), 'bodyClass' => 'card-body-no-padding'])
        @slot('buttons')
...
{{--                <div id="filters">--}}
{{--                    <form action="{{ route('admin.load-types.index') }}" method="get">--}}
{{--                        <div class="row">--}}
{{--                            <div class="col-md-12">--}}
...
{{--                                    <a href="{{ route('admin.load-types.index') }}" class="btn btn-sm btn-danger">@lang('admin.filters_reset')</a>--}}
...
{{--            <a href="{{ route('admin.load-types.create') }}" class="btn btn-sm btn-primary ml-2">--}}
...
<div class="row col-sm-6 justify-content-end">
    ...
    {{--    </button>--}}
    <a href="{{ route('admin.load-types.create') }}" class="btn btn-info ml-2">
        <span class="d-none d-sm-inline-block">@lang('admin.create')</span> <i class="icmn-plus"><!-- --></i>
    </a>
</div>
                            ...
                            <td class="table__td">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('admin.load-types.edit', $item) }}" class="dropdown-item">
                                            @lang('admin.edit')
                                        </a>
                                        <div class="dropdown-item " onclick="
                                            ...
                                            ">
                                            <form action="{{ route('admin.load-types.destroy', $item) }}" class="d-inline-block" method="post">
                                                @csrf
                                                @method('delete')
        ...
        @slot('bottom')
            @include('ui.pagination', ['data' => $loadTypes])
        @endslot
    @endcomponent
@endsection
