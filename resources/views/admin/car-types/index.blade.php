...
@section('center_content')
    @component('component.card', ['title' => trans('admin.nav.car-types'), 'bodyClass' => 'card-body-no-padding'])
        @slot('buttons')
...
{{--                <div id="filters">--}}
{{--                    <form action="{{ route('admin.car-types.index') }}" method="get">--}}
{{--                        <div class="row">--}}
{{--                            <div class="col-md-12">--}}
...
{{--                                    <a href="{{ route('admin.car-types.index') }}" class="btn btn-sm btn-danger">@lang('admin.filters_reset')</a>--}}
...
{{--            <a href="{{ route('admin.car-types.create') }}" class="btn btn-sm btn-primary ml-2">--}}
...
{{--    </button>--}}
    <a href="{{ route('admin.car-types.create') }}" class="btn btn-info ml-2">
        <span class="d-none d-sm-inline-block">@lang('admin.create')</span> <i class="icmn-plus"><!-- --></i>
    </a>
</div>
                ...
                <table class="table">
                    <thead class="table__thead">
                        <tr>
                            ...
                            <th class="table__th">@lang('validation.attributes.icon')</th>
...
{{--                            <th class="table__th"></th>--}}
                    ...
                    @foreach($carTypes as $item)
                        <tr class="table__tr mt-2 mb-2 ">
                            ...
                            <td class="table__td">
                                <img src="{{ $item->imageUrl() }}" alt="{{ $item->title }}" width="75px">
                            </td>
                            <td class="table__td">{{ $item->title }}</td>
{{--                            <td class="table__td">--}}
{{--                                <div>--}}
{{--                                    <strong>--}}
{{--                                        @lang('validation.attributes.min_distance'):--}}
{{--                                    </strong> {{ $item->min_distance }}--}}
{{--                                </div>--}}
{{--                                <div>--}}
{{--                                    <strong>--}}
{{--                                        @lang('validation.attributes.min_price'):--}}
{{--                                    </strong> {{ $item->min_price }}--}}
{{--                                </div>--}}
{{--                                <div>--}}
{{--                                    <strong>--}}
{{--                                        @lang('validation.attributes.price_per_km'):--}}
{{--                                    </strong> {{ $item->price_per_km }}--}}
{{--                                </div>--}}
{{--                                <div>--}}
{{--                                    <strong>--}}
{{--                                        @lang('validation.attributes.commission'):--}}
{{--                                    </strong> {{ $item->commission }}--}}
{{--                                </div>--}}
{{--                            </td>--}}
                            ...
                            <td class="table__td">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{ route('admin.car-types.restrictions', $item) }}" class="dropdown-item">
                                            @lang('admin.restrictions')
                                        </a>
                                        <a href="{{ route('admin.car-types.rates.edit', $item) }}" class="dropdown-item">
                                            Тарифы
                                        </a>
                                        <div class="dropdown-item " onclick="
                                            ...
                                            ">
                                            <form action="{{ route('admin.car-types.destroy', $item) }}" class="d-inline-block w-100" method="post">
                                                @csrf
                                                @method('delete')
        ...
        @slot('bottom')
            @include('ui.pagination', ['data' => $carTypes])
        @endslot
    @endcomponent
@endsection
