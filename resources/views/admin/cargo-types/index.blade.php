...
@section('center_content')
    @component('component.card', ['title' => trans('admin.nav.cargo-types'), 'bodyClass' => 'card-body-no-padding'])
        @slot('buttons')
...
<div class="row col-sm-6 justify-content-end">
    ...
    {{--    </button>--}}
    <a href="{{ route('admin.cargo-types.create') }}" class="btn btn-info ml-2">
        <span class="d-none d-sm-inline-block">@lang('admin.create')</span> <i class="icmn-plus"><!-- --></i>
    </a>
</div>
                            ...
                            <td class="table__td">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('admin.cargo-types.edit', $item) }}" class="dropdown-item">
                                            @lang('admin.edit')
                                        </a>
                                        <div class="dropdown-item " onclick="
                                            ...
                                            ">
                                            <form action="{{ route('admin.cargo-types.destroy', $item) }}" class="d-inline-block" method="post">
                                                @csrf
                                                @method('delete')
        ...
        @slot('bottom')
            @include('ui.pagination', ['data' => $cargoTypes])
        @endslot
    @endcomponent
@endsection
