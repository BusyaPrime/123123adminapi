...
@section('center_content')
    @component('component.card', ['title' => 'Приоритеты юр. лиц', 'bodyClass' => 'card-body-no-padding'])
        @slot('buttons')


<div class="row col-sm-6 justify-content-end">
    <a href="{{ route('admin.company_priorities.create') }}" class="btn btn-info ml-2">
                ...
                <table class="table">
                    <thead class="table__thead">
                        <tr>
                            ...
                            <th class="table__th">Лимит долга</th>
                    ...
                    @foreach($priorities as $item)
                        <tr class="table__tr mt-2 mb-2 ">
                            ...
                            <td class="table__td">{{ $item->quantity != null ? number_format($item->quantity, 0, '', ' ') : '0' }} сум</td>
                            <td class="table__td">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('admin.company_priorities.edit', $item) }}" class="dropdown-item">
                                            @lang('admin.edit')
                                        </a>
                                        <div class="dropdown-item " onclick="
                                            ...
                                            ">
                                            <form action="{{ route('admin.company_priorities.destroy', $item) }}" id="delete_form" class="d-inline-block" method="post">
                                                @csrf
                                                @method('delete')
        ...
        @slot('bottom')
            @include('ui.pagination', ['data' => $priorities])
        @endslot
    @endcomponent
@endsection
