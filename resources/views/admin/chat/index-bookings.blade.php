    ...
    @component('component.card', ['title' => 'Чат', 'bodyClass' => 'card-body-no-padding'])
        ...
        @slot('buttons')
            ...
            <div class="row col-sm-6 justify-content-end">
                <a href="{{ route('admin.chat.index', ['type' => 'users']) }}" class="btn btn-default  mr-3">Пользователи</a>
                <a href="{{ route('admin.chat.index', ['type' => 'drivers']) }}" class="btn btn-default  mr-3">Водители</a>
                <a href="{{ route('admin.chat.index-bookings') }}" class="btn  btn-primary active mr-3">Заказы</a>
            </div>
            ...
            <section class="content-body pl-4 pr-4 pt-4 pb-5" >
                    <div class="col-sm-12 border rounded d-flex justify-content-between pr-0" style="height: 60vh; gap:2px;overflow: hidden;">
                        <div class="col-sm-5 pt-3 border-right d-flex flex-column" style="overflow: auto">
                            <form action="{{ route('admin.chat.index-bookings') }}" id="search_form">
                            ...
                            @foreach($chats as $chat)
                                <a href="{{ route('admin.chat.index-bookings', ['chat_id' => $chat->id]) }}" class="">
                                ...
                                <div class="col-sm-12 d-flex flex-column justify-content-between p-0">
                                    ...
                                    <div class="d-flex p-2 border-bottom">
                                        <div class="col-sm-8 d-flex" style="gap:10px;">
                                            <a href="{{ route('admin.bookings.show', $selected_booking) }}" class="">
...
{{--                                            <img src="../dist/img/Options--.png" alt="">--}}
                                    ...
                                    @endif
                                        @if($selectedChatId)
                                        <form action="{{ route('admin.chat.index-bookings', ['chat_id'=> $selectedChatId]) }}" method="post">
                                            @csrf
