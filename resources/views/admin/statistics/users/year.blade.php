...
@section('center_content')
    @component('component.card', ['title' => 'Пользователи, Водители, Компании', 'bodyClass' => 'card-body-no-padding'])

        @slot('buttons')

            <div class="row col-sm-6 justify-content-end">
                <a  class="btn btn-primary active   mr-3">Год</a>
                <a href="{{ route('admin.statistics.users.month') }}" class="btn btn-default mr-3">Месяц</a>
                <div class="col-5">
