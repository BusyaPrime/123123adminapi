...
@section('center_content')
    @component('component.card', ['title' => "Сезоны", 'bodyClass' => 'card-body-no-padding'])
        @slot('buttons')
...
{{--    </button>--}}
    <a href="{{ route('admin.seasons.create') }}" class="btn btn-info ml-2">
        <span class="d-none d-sm-inline-block">@lang('admin.create')</span> <i class="icmn-plus"><!-- --></i>
    </a>
</div>
...
{{--                                </div>--}}
{{--                            </td>--}}
                            <td class="table__td">{{ trans('admin.months.'.$item->month_start).' - '.trans('admin.months.'.$item->month_end)  }}</td>
                            <td class="table__td">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a href="{{ route('admin.seasons.edit', $item) }}" class="dropdown-item">
                                            @lang('admin.edit')
                                        </a>
                                        <div class="dropdown-item " onclick="
                                            ...
                                            ">
                                            <form action="{{ route('admin.seasons.destroy', $item) }}" class="d-inline-block w-100" method="post">
                                                @csrf
                                                @method('delete')
        ...
        @slot('bottom')
            @include('ui.pagination', ['data' => $seasons])
        @endslot
    @endcomponent
@endsection
